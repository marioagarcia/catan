...
public class EdgeLocationTest {
	...
	public void testGetAdjacent() {
		...
		EdgeLocation[] result1 = edgeLocation.getAdjacent();
		...
		EdgeLocation[] result2 = edgeLocation.getAdjacent();
		...
		EdgeLocation[] result3 = edgeLocation.getAdjacent();
...
//		for(EdgeLocation location : result3){
